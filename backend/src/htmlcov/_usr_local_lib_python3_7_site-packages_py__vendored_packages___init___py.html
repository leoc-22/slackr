...
<head>
    ...
    <title>Coverage for /usr/local/lib/python3.7/site-packages/py/_vendored_packages/__init__.py: 100%</title>
...
<div id="header">
    <div class="content">
        <h1>Coverage for <b>/usr/local/lib/python3.7/site-packages/py/_vendored_packages/__init__.py</b> :
