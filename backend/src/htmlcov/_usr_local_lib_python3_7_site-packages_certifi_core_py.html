...
<head>
    ...
    <title>Coverage for /usr/local/lib/python3.7/site-packages/certifi/core.py: 100%</title>
...
<div id="header">
    <div class="content">
        <h1>Coverage for <b>/usr/local/lib/python3.7/site-packages/certifi/core.py</b> :
